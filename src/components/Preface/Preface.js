...
const Preface = () => (
  <div className={`${styles.prefaceContainer}`}>
    ...
    <p>
      ...
      of which had appeared in 1797-8. Passow had laid down, in his Essay on Zweck, Anlage, und
      Ergänzung griechischer Wörterbücher, published in 1812, the canons by which the lexicographer
      should be guided, amongst which the most important was the requirement that citations should
      be chronologically arranged in order to exhibit the history of each word and its uses. In
      obedience to this principle, Passow based his work on a special study of the Early Epic
      vocabulary, and the relatively full treatment of Homeric usage is a legacy bequeathed by him
      to Liddell and Scott which has persisted throughout the successive editions of their work. The
      first edition of his Lexicon appeared in 1819, and his expressed intention was to expand the
      work gradually by incorporating successively the results of special studies of Early Lyric
      Poetry, the Ionic Prose of Herodotus and Hippocrates, the Attic dramatists, and the Attic
      Prose writers: but little change was made in his second and third editions (1825 and 1827),
      and the fourth (1831), in which the Early Lyric poets and Herodotus received fuller
    ...
    <p>
      ...
      In the meantime two attempts had been made to adapt the Thesaurus Linguae Graecae of Henri
      Estienne to modern uses. The first of these was the result of the activities of Abraham Valpy,
      and was largely the work of E. H. Barker of Trinity College, Cambridge. It was completed in
      nine folio volumes, published in 1819-28, and reproduced the text of Stephanus&apos;
      Thesaurus, interlarded with a mass of copious but ill-digested information. The first volume
      met with vigorous and not undeserved criticism on the part of Bishop Blomfield in an article
      in the Quarterly Review (vol. xxii, pp. 302 ff.) which is marred by a lavish display of odium
      philologicum. The editors, however, profited by the Bisho&apos;s strictures, and his prophecy
      that a work in which 139 columns were devoted to the word ἄγαλμα would run to fifty volumes
      and attain to completion in 1889 was signally falsified. The work labours under the serious
      disadvantage of retaining the etymological arrangement of Stephanus,1 which forces the reader
      to make a laborious search for any compound or derived word.

    </p>
    <p>

      This mistake was avoided by the compilers of the Paris Thesaurus, the publication of which was
      begun in 1831 by Firmin-Didot, and was placed under the general editorship of Karl Benedict
      Hase. This enterprise was also subjected to criticism in the Quarterly Review (vol. li, pp.
      144 ff.) by J. R. Fishlake (the translator of Buttmann&apos;s Lexilogus) on the ground of its
      unwieldy bulk; but the association of the brothers Wilhelm and Ludwig Dindorf at an early
      stage of the work2 enabled it to be carried through in thirty-four years, and its vast
      collections of material, though often ill-arranged and unevenly treated, were largely drawn
      upon by Liddell and Scott in their successive editions.
    ...
    <p>
      ...
      philological information was recast in the light of G. Curtius&apos; Griechische Etymologie
      (1858). There were 10,000 copies of this edition, priced at 31s. 6d. The sixth is dated in
      1869; it was again considerably augmented, the number of pages being increased from 1,644 to
      1,865, and the verbal forms were more fully given with the aid of Veitch&apos;s Greek Verbs,
      irregular and defective (2nd ed., 1866). Of this edition 15,00000 copies were printed, and the
      price was raised to 36s. Fourteen years later appeared a seventh edition, revised by Liddell,
      whose Preface is dated October 1882; the page was enlarged, and this made a reduction in the
      number to 1,776 possible. Bonitz&apos;s Index to Aristotle (1870) and Roehl&apos;s Index to
      CIG (1877) were largely drawn upon, and help was received from American scholars-Professors
      Drisler, Goodwin, and Gildersleeve-especially in regard to the particles and the technical
      terms of Attic law. This edition was stereotyped, and from time to time reprinted. Finally, in
      1897, there was published an eighth edition, in which such corrections were made as could be
      inserted without altering the pagination. This made it impossible to take full account of such
      new sources as the Ἀθηναίωβ Πολιτεία, but there was a short list of Addenda, containing
      references to this work and to inscriptions published in the Journal of Hellenic Studies.
      Liddell appears to have been engaged for some years after the publication of the seventh
      edition on a lexicographical study of inscriptions; Sir William Thiselton-Dyer has kindly
      placed at my disposal two volumes of an interleaved edition of the abridged Lexicon in which
      his collections of material, largely drawn from the Corpus Inscriptionum Atticarum and
      Roehl&apos;s Inscriptiones Graecae Antiquissimae, are contained; but he seems to have laid
      the work aside in his later years, and he died in 1898, at the age of 87, a few months after
      the appearance of the eighth edition.
    ...
    <p>
      ...
      which the difficulty and magnitude of the enterprise were emphasized3 a Committee of Inquiry,
      consisting of Sir R. C. Jebb, Professors Diels, Gomperz, Heiberg, Krumbacher, Leo, and M.
      Perrot, with power to co-opt, was appointed to consider method, means, and preliminary
      questions in connexion with the proposal. In 1905 Prof. P. Kretschmer was added to the
      Committee, which drafted a memorandum on the question of establishing a periodical
      &apos;Archiv&apos; and an office for the collection of slips. At the close of the year Jebb,
      who had acted as Chairman, died, and was replaced in 1906 by Gomperz, while Bywater was added
      to the Committee, which, at a meeting held at Vienna in May, decided to constitute itself a
    ...
    <p>
      ...
      the Neue Jahrbücher for 1905,4 in the course of which he wrote as follows: “Any one who bears
      in mind the bulk of Greek literature, which is at least 10 times as great [as that of Latin],
      its dialectical variations, its incredible wealth of forms, the obstinate persistence of the
      classical speech for thousands of years down to the fall of Constantinople, or, if you will,
      until the present day: who knows, moreover, that the editions of almost all the Greek classics
      are entirely unsuited for the purposes of slipping, that for many important writers no
      critical editions whatever exist: and who considers the state of our collections of fragments
      and special Lexica, will see that at the present time all the bases upon which a Greek
      Thesaurus could be erected are lacking.
    ...
    <p>
      ...
      purchase the Thesaurus Graecus for (say) 6,ooo marks-how could one read and use such a
      monstrosity?
    ...
    <p>
      ...
      promising plan that of the New English Dictionary.
    ...
    <p>
      ...
      At about the date when the project of a Thesaurus Graecus was finally abandoned, a proposal
      was made by a group of Greek scholars for the preparation of a Lexicon of the Greek
      ...
      Krumbacher, in one of his latest articles in the Byzantinische Zeitschrift,6; criticized the
      project, and advised the Greek scholars to confine themselves in the first instance to the
      Modern tongue; and though this recommendation was not, as it seems, formally adopted, the
      preliminary publications of the Commission consist mainly in a series of studies of the modern
      dialects, which appear as supplements to Ἀθηνᾶ, and it would appear that a Lexicon of Medieval
      and Modern Greek is contemplated in the first instance.
    ...
    <p>
      ...
      page in the Lexicon which does not bear traces of his handiwork.7
    ...
    <p>
      ...
      ” which, he thought, would equal the Latin Thesaurus in bulk!5
    ...
    <p>
      ...
      recent papyrological publications and on unedited documents in the British Museum Collection.9
      For the vocabulary of the Inscriptions little could be done by the editor except to revise the
      existing references to Boeckh&apos;s Corpus Inscriptionum Graecarum-no light task, seeing that
      so many of the stones have been re-examined and may be studied in improved texts-and to
      supplement these corrected citations by illustrations from collections such as those of
      Dittenberger10 or Michel or the Griechische Dialektinschriften, with the aid of
      Herwerden&apos;s Lexicon Suppletorium, a work unfortunately marred by constant inaccuracy of
      reference, which it is charitable to ascribe to lack of the minute care required in
      lexicographical proofreading. I was therefore compelled to invoke the aid of Mr. M. N. Tod, to
      whom I owe an incalculable debt for his services in this field. Mr. Tod has for several years
      read with an eye to the improvement of the Lexicon every epigraphical publication which has
      ...
      publications of the inscriptions of Delphi, Ephesus, Magnesia, Miletus, and Priene, and has
      excerpted the whole of the periodical literature in which inscriptions are to be found, so
      that it is hard to believe that any new material of real importance which has accrued since
      1911 can have escaped his methodical scrutiny. I have also received help in epigraphical
      matters from Professor M. Cary and Miss C. A. Hutton.

    </p>
    <p>

      Turning to Literature proper, it soon became clear that while the references to Plato and
      Aristotle needed careful revision and some amplification,11 the terminology of the later
      schools of Philosophy had never been adequately treated by lexicographers. Neither
      Usener&apos;s Epicurea nor von Arnim&apos;s Stoicorum Veterum Fragmenta possesses an index;
      and Mr. (now Professor) J. L. Stocks generously undertook to remedy this defect, and to supply
      ...
      Unfortunately his work was interrupted by the Great War, and on his return from service Mr.
      Stocks found himself unable to work up the material which he had collected within the
      necessary limits of time. His notes on Stoic terminology were therefore transferred to Mr. A.
      C. Pearson, who carried the work a stage further, but found, after his appointment to the
      Regius Professorship of Greek at Cambridge, that he would not have time to complete it.
      Professor E. V. Arnold of Bangor, who is retiring from his post, hopes to find the leisure
      necessary for this much-needed work.
    ...
    <p>
      ...
      Proclus&apos; Commentary on the Republic of Plato. As a matter of fact, this word can be
      quoted from ten authors besides Proclus.12 Professor Burnet, who in his edition of the Phaedo
      drew attention to some of these passages, added: ‘Hippolytus, Clement and other Christian
      writers say μετενσωμάτωσις (“reincarnation”) which is accurate but cumbrous’; but the
      ...
      that of ἄτοπος in the philosophical sense of &apos;non-spatial&apos; has escaped
      lexicographers. In dealing with this branch of literature I have received help from various
      scholars, notably Professor A. E. Taylor; and the late Mr. M. G. Davidson read the Enneads of
      Plotinus, the abstruse work of Damascius περὶ ἀρχῶν, and other treatises. The extant
      commentaries on the works of Aristotle of course belong to this school of thought, and Mr. W.
      D. Ross kindly undertook to supply notes on their vocabulary with the aid of the excellent
      indices of the Berlin edition and with the collaboration of certain of the Oxford
      translators;13 the bulk of this work, however, fell upon his own shoulders.

    </p>
    <p>

      Another branch of literature demanding special study was that of the magical and mystical
      writings-the Corpus Hermeticum, the magical papyri, the Tabellae Defixionum, and such like.
      This field was carefully worked over by Mr. Walter Scott, whose notes dealt very fully with
      the difficult words often found in these sources.
    ...
    <p>
      ...
      Moulton and Milligan&apos;s Vocabulary of the Greek Testament which (within its natural
      limits) may almost be regarded as a Lexicon of the κοινή as a whole. I owe a deep debt of
      gratitude to Professor Milligan for supplying advance proofs of the Vocabulary, the fifth part
      of which has just been published. Prof. A. H. McNeile and the Rev. A. Llewellyn Davies have
      advised me in matters relating to the LXX, Hexapla, etc.
    ...
    <p>
      ...
      including Lucian, the Anthology, all the later Epic poets, the Scriptores Erotici, Aelian,
      Philostratus, and others. From that time onwards Mr. Greene has not ceased to read and excerpt
      the remains of later Greek literature, including the works of practically every non-technical
      writer of importance from Polybius to Procopius. The twenty-four volumes have grown to nearly
      eighty, and many of the notes which they contain are elaborate dissertations constituting an
      important contribution to Classical Scholarship. Valuable aid has also been received from
      Professor W. A. Goligher, who read the minor Greek historians, Mr. J. M. Edmonds, who supplied
      a vocabulary of the Greek Lyric poets, Mr. J. H. A. Hart, who is compiling an index verborum
      to Philo, Professor A. W. Mair and Mr. M. T. Smiley, whose notes on Callimachus have been of
      great use, and other scholars, such as Professors J. A. Platt, A. Souter, R. L. Dunbabin, and
      W. L. Lorimer, Mr. T. W. Allen, Mr. A. H. Smith, Mr. G. Middleton, and the late Mr. G. E.
      Underhill, to all of whom special thanks are due. The advice of Mr. Edgar Lobel has been
      constantly sought and freely given, especially in regard to the remains of Early Lyric poetry
      and the ancient lexicographers.
    ...
    <p>
      ...
      Boisacq&apos;s Dictionnaire étymologique de la langue grecque will show that the speculations
      of etymologists are rarely free from conjecture; and the progress of comparative philology
      since the days of G. Curtius (whose Griechische Etymologie was the main source drawn upon by
      Liddell and Scott) has brought about the clearance of much rubbish but little solid
      construction. Some assured results, however, have been attained, and the etymologies presented
      in the text have in almost every case been approved by Mr. McKenzie.
    ...
    <p>
      ...
      intended their work to be a Lexicon of Classical Greek,14 admitted a number of words from
      Ecclesiastical and Byzantine writers, for many of which no reference was given except the
      symbols Eccl.&apos; and &apos;Byz.&apos; After due consideration it has been decided to
      exclude both Patristic and Byzantine literature from the purview of the present edition. It
      would have manifestly been impossible to include more than a small and haphazard selection of
      ...
      illustration has been given of the vocabulary and usage of all writers of importance,
      accompanied by precise and easily verifiable references. There is, moreover, in preparation a
      Lexicon of Patristic Greek (including Christian poetry and inscriptions) under the editorship
      of Dr. Darwell Stone, which will, it is hoped, be printed when the publication of the present
      work is concluded.15 For the Byzantine vocabulary we shall have to wait for the Modern Greek
      Lexicon to which allusion has already been made, but it will hardly be denied that some time-
      limit was called for, and this has been fixed roughly at A. D. 600 in order to include the
    ...
    <p>
      ...
      Wörterbuch der griechischen Sprache by Wilhelm Crönert, of which three parts, extending as far
      as ἀνά, appeared in 1912-14. This monument of Herculean toil will, if and when it is completed
      (a consummation for which all lovers of learning will devoutly pray), bulk about three times
      as large as Liddell and Scott; in fact, this estimate may be exceeded if Crönert is able to
      carry out the plan foreshadowed in the preface to his second part, where he looks forward to
      the gradual expansion of his work as it proceeds (after the manner of Passow) by means of a
      fuller treatment of post-Classical Greek. Cronert&apos;s work has been criticized by
      Kretschmer,16 who regards it as too ambitious in scope and unlikely to be completed within a
      reasonable period of time, and would prefer a Lexicon on a somewhat smaller scale as a
      preliminary to the Thesaurus Linguae Graecae which must remain for a long while to come a
      pious aspiration. It may be hoped that the present work will do something to supply this need,
      and that it may be found to possess some compensating advantages denied to the larger Lexicon
      of Crönert, such as the provision of exact references for every word cited from an author and
      fuller and more representative quotations from the later literature, e.g. from such authors as
      Plotinus.17
    ...
    <p>
      ...
      publications as Ulrich Wilcken&apos;s Urkunden der Ptolemäerzeit furnish more accurate
      readings of Papyri and necessitate changes or deletions,18 and I must place on record my
      gratitude to Professor Wilcken for kindly undertaking to verify and correct references to
      documents in the yet unpublished portions of his work,19 as also to Mr. J. U. Powell for
      permitting me to use and refer to the proofs of his Collectanea Alexandrina, shortly about to
      appear. Professor J. Bidez and Mr. A. D. Knox kindly sent me advanced proofs of the editions
      of the Epistles of Julian and of Herodas in which they have collaborated. The care and
      accuracy shown by the Press readers have been altogether exceptional.
