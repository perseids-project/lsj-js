...
const Preface = () => (
  <div className={`${styles.prefaceContainer}`}>
    ...
    <p>
      ...
      of which had appeared in 1797-8. Passow had laid down, in his Essay on <u>Zweck, Anlage, und
      Ergänzung griechischer Wörterbücher</u>, published in 1812, the canons by which the
    ...
    <p>
      ...
      In the meantime two attempts had been made to adapt the <u>Thesaurus Linguae Graecae</u> of
      ...
      Stephanus&apos; <u>Thesaurus</u>, interlarded with a mass of copious but ill-digested
      information. The first volume met with vigorous and not undeserved criticism on the part of
      Bishop Blomfield in an article in the <u>Quarterly Review</u> (vol. xxii, pp. 302 ff.) which
      ...
      arrangement of Stephanus,<sup><a href="javascript:;" data-toggle="tooltip" data-placement="top" title="information">1 </a> </sup> which forces the reader to make a laborious search for any compound
      or derived word.

    </p>
    <p>

      This mistake was avoided by the compilers of the Paris <u>Thesaurus</u>, the publication of
      which was begun in 1831 by Firmin-Didot, and was placed under the general editorship of Karl
      Benedict Hase. This enterprise was also subjected to criticism in the <u>Quarterly</u> Review
      (vol. li, pp. 144 ff.) by J. R. Fishlake (the translator of Buttmann&apos;s <u>Lexilogus</u>)
      on the ground of its unwieldy bulk; but the association of the brothers Wilhelm and Ludwig
      Dindorf at an early stage of the work2 enabled it to be carried through in thirty-four years,
    ...
    <p>
      ...
      philological information was recast in the light of G. Curtius&apos; <u>Griechische 
      Etymologie</u> (1858). There were 10,000 copies of this edition, priced at 31s. 6d. The sixth
      ...
      <u>Greek Verbs, irregular and defective</u> (2nd ed., 1866). Of this edition 15,00000 copies
      ...
      and Roehl&apos;s Index to <u>CIG</u> (1877) were largely drawn upon, and help was received
      ...
      <u>Journal of Hellenic Studies</u>. Liddell appears to have been engaged for some years after
      ...
      abridged Lexicon in which his collections of material, largely drawn from the <u>Corpus
      Inscriptionum Atticarum</u> and Roehl&apos;s <u>Inscriptiones Graecae Antiquissimae</u>, are
    ...
    <p>
      ...
      &apos; <u>Archiv</u>&apos; and an office for the collection of slips. At the close of the year
      Jebb, who had acted as Chairman, died, and was replaced in 1906 by Gomperz, while Bywater was
      added to the Committee, which, at a meeting held at Vienna in May, decided to constitute
      itself a permanent and independent body.

    </p>
    <p>

      The difficulties of the project had been incisively stated by Diels in an article published in
      the <u>Neue Jahrbücher</u> for 1905,4 in the course of which he wrote as follows: “Any one who
      bears in mind the bulk of Greek literature, which is at least 10 times as great [as that of
      Latin], its dialectical variations, its incredible wealth of forms, the obstinate persistence
      of the classical speech for thousands of years down to the fall of Constantinople, or, if you
      will, until the present day: who knows, moreover, that the editions of almost all the Greek
      classics are entirely unsuited for the purposes of slipping, that for many important writers
      no critical editions whatever exist: and who considers the state of our collections of
      fragments and special Lexica, will see that at the present time all the bases upon which a
      Greek Thesaurus could be erected are lacking.
    ...
    <p>
      ...
      purchase the <u>Thesaurus Graecus</u> for (say) 6,ooo marks-how could one read and use such a
      monstrosity?
    ...
    <p>
      ...
      promising plan that of the <u>New English</u> Dictionary.
    ...
    <p>
      ...
      At about the date when the project of a <u>Thesaurus Graecus</u> was finally abandoned, a
      ...
      Krumbacher, in one of his latest articles in the <u>Byzantinische Zeitschrift</u>,6;
    ...
    <p>
      ...
      and worked up a small portion of it in a series of articles in the <u>Medico-Chirurgical
      Journal</u>. He proposed to the Delegates that he should collaborate with M. Daremberg in
      ...
      there is scarcely a page in the Lexicon which does not bear traces of his handiwork.7
    ...
    <p>
      ...
      had already been communicated to Sir Arthur Hort for use in his edition of Theophrastus&apos;
       <u>Historia Plantarum</u>.8

    </p>
    <p>

      The province of Greek Mathematics belongs in a special sense to Sir Thomas Heath, F.R.S.,
      Whose <u>History of Greek Mathematics</u> and editions of Euclid, Apollonius of Perga,
    ...
    <p>
      ...
      correct a number of mistakes made by previous lexicographers. His <u>Glossary of Greek
      Birds</u> has been in constant use, and his version of the <u>Historia Animalium</u> in the
    ...
    <p>
      ...
      <u>Almagest</u> of Ptolemy and other astronomical writings, and thereby greatly increasing the
    ...
    <p>
      ...
      existing references to Boeckh&apos;s <u>Corpus Inscriptionum Graecarum</u>-no light task,
      seeing that so many of the stones have been re-examined and may be studied in improved texts-
      and to supplement these corrected citations by illustrations from collections such as those of
      Dittenberger10 or Michel or the <u>Griechische Dialektinschriften</u>, with the aid of
      Herwerden&apos;s <u>Lexicon Suppletorium</u>, a work unfortunately marred by constant
      inaccuracy of reference, which it is charitable to ascribe to lack of the minute care required
      in lexicographical proofreading. I was therefore compelled to invoke the aid of Mr. M. N. Tod,
      to whom I owe an incalculable debt for his services in this field. Mr. Tod has for several
      years read with an eye to the improvement of the Lexicon every epigraphical publication which
      has appeared, such for example as the later volumes of the <u>Inscriptiones Graecae</u>,
      Cagnat&apos;s <u>Inscriptiones Graecae ad res Romanas pertinentes</u>, the <u>Tituli Asiae
      Minoris</u>, and the special publications of the inscriptions of Delphi, Ephesus, Magnesia,
      Miletus, and Priene, and has excerpted the whole of the periodical literature in which
      inscriptions are to be found, so that it is hard to believe that any new material of real
      importance which has accrued since 1911 can have escaped his methodical scrutiny. I have also
      received help in epigraphical matters from Professor M. Cary and Miss C. A. Hutton.
    ...
    <p>
      ...
      Usener&apos;s <u>Epicurea</u> nor von Arnim&apos;s <u>Stoicorum Veterum Fragmenta</u>
      possesses an index; and Mr. (now Professor) J. L. Stocks generously undertook to remedy this
      defect, and to supply me with a vocabulary of the important technical terms of the Stoic and
      Epicurean schools (including in his survey of the latter such later works as the tracts or
      other remains of Philodemus, Polystratus, Demetrius Lacon, Diogenianus, and Diogenes of
      Oenoanda). Unfortunately his work was interrupted by the Great War, and on his return from
      service Mr. Stocks found himself unable to work up the material which he had collected within
      the necessary limits of time. His notes on Stoic terminology were therefore transferred to Mr.
      A. C. Pearson, who carried the work a stage further, but found, after his appointment to the
    ...
    <p>
      ...
      Proclus&apos; Commentary on the <u>Republic</u> of Plato. As a matter of fact, this word can
      be quoted from ten authors besides Proclus.12 Professor Burnet, who in his edition of the 
      <u>Phaedo</u> drew attention to some of these passages, added: ‘Hippolytus, Clement and other
      Christian writers say μετενσωμάτωσις (“reincarnation”) which is accurate but cumbrous’; but
      the implication that this word belongs to Patristic Greek is misleading. It is found in
      Plotinus and in later Platonists such as Hierocles and Proclus. Again, such a characteristic
      use as that of ἄτοπος in the philosophical sense of &apos;non-spatial&apos; has escaped
      lexicographers. In dealing with this branch of literature I have received help from various
      scholars, notably Professor A. E. Taylor; and the late Mr. M. G. Davidson read the
      <u>Enneads</u> of Plotinus, the abstruse work of Damascius περὶ ἀρχῶν, and other treatises.
      The extant commentaries on the works of Aristotle of course belong to this school of thought,
      and Mr. W. D. Ross kindly undertook to supply notes on their vocabulary with the aid of the
      excellent indices of the Berlin edition and with the collaboration of certain of the Oxford
    ...
    <p>
      ...
      writings-the <u>Corpus Hermeticum</u>, the magical papyri, the <u>Tabellae Defixionum</u>, and
    ...
    <p>
      ...
      Moulton and Milligan&apos;s <u>Vocabulary of the Greek Testament</u> which (within its natural
      limits) may almost be regarded as a Lexicon of the κοινή as a whole. I owe a deep debt of
      gratitude to Professor Milligan for supplying advance proofs of the <u>Vocabulary</u>, the
    ...
    <p>
      ...
      including Lucian, the Anthology, all the later Epic poets, the <u>Scriptores Erotici</u>, Aelian,
    ...
    <p>
      ...
      Boisacq&apos;s <u>Dictionnaire étymologique de la langue grecque</u> will show that the
      speculations of etymologists are rarely free from conjecture; and the progress of comparative
      philology since the days of G. Curtius (whose <u>Griechische Etymologie</u> was the main
    ...
    <p>
      ...
      <u>Wörterbuch der griechischen Sprache</u> by Wilhelm Crönert, of which three parts, extending
      ...
      by Kretschmer,16 who regards it as too ambitious in scope and unlikely to be completed within
      a reasonable period of time, and would prefer a Lexicon on a somewhat smaller scale as a
      preliminary to the <u>Thesaurus Linguae Graecae</u> which must remain for a long while to come
      a pious aspiration. It may be hoped that the present work will do something to supply this
      need, and that it may be found to possess some compensating advantages denied to the larger
      Lexicon of Crönert, such as the provision of exact references for every word cited from an
      author and fuller and more representative quotations from the later literature, e.g. from such
      authors as Plotinus.17
    ...
    <p>
      ...
      publications as Ulrich Wilcken&apos;s <u>Urkunden der Ptolemäerzeit</u> furnish more accurate
      ...
      permitting me to use and refer to the proofs of his <u>Collectanea Alexandrina</u>, shortly
      about to appear. Professor J. Bidez and Mr. A. D. Knox kindly sent me advanced proofs of the
      editions of the <u>Epistles of Julian</u> and of Herodas in which they have collaborated. The
